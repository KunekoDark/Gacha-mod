...
public class ModOreGeneration {
    public static void generateOres(final BiomeLoadingEvent event){
        for(OreType ore : OreType.values()){
            ...
            // bottomOffset - min height for ore
            // maximum - minHeight + maximum = top level (vertical expansion of ore)
            // topOffset - subtracted from maximum to give actual top level
