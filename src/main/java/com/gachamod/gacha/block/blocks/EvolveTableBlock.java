...
import com.gachamod.gacha.entity.tileentity.EvolveTableTile;
...
public class EvolveTableBlock extends Block {
    public EvolveTableBlock(Properties properties, IWorldPosCallable worldPosCallable) {
        super(properties);
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if(!worldIn.isRemote()){
            ...
            if(tileEntity instanceof EvolveTableTile){
    ...
    private INamedContainerProvider createContainerProvider(World worldIn, BlockPos pos) {
        return new INamedContainerProvider() {
            ...
            public ITextComponent getDisplayName() {
                return new TranslationTextComponent("screen.gacha.evolve_table");
            }
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return ModTileEntities.EVOLVE_TABLE_TILE.get().create();
    }
