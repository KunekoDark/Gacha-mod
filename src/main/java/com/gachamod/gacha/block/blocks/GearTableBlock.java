...
import com.gachamod.gacha.container.containers.GearTableContainer;
import com.gachamod.gacha.entity.tileentity.GearTableTile;
...
public class GearTableBlock extends Block {
    public GearTableBlock(Properties properties) {
        super(properties);
    }
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if(!worldIn.isRemote()){
            ...
            if(!player.isCrouching()){
                if(tileEntity instanceof GearTableTile){
    ...
    private INamedContainerProvider createContainerProvider(World worldIn, BlockPos pos) {
        return new INamedContainerProvider() {
            ...
            public ITextComponent getDisplayName() {
                return new TranslationTextComponent("screen.gacha.gear_table");
            }

            @Nullable
            @Override
            public Container createMenu(int i, PlayerInventory playerInventory, PlayerEntity playerEntity) {
                return new GearTableContainer(i , worldIn, pos, playerInventory, playerEntity);
            }
        };
    }
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return ModTileEntities.GEAR_TABLE_TILE.get().create();
    }
