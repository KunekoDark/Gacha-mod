...
import com.gachamod.gacha.container.JizoFurnaceContainer;
...
public class JizoFurnaceScreen extends ContainerScreen<JizoFurnaceContainer> {
    private final ResourceLocation GUI = new ResourceLocation(Gacha.MOD_ID,
            "textures/gui/jizo_furnace_gui.png");

    public JizoFurnaceScreen(JizoFurnaceContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
