...
public class AlienSwordItem extends SwordItem {
    public AlienSwordItem(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builderIn) {
...
//MAKE ALIEN CHARGER BACKWARDS COMPATIBLE WITH TERRESTRIAL STUFF
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        if(playerIn.getHeldItem(handIn).getDamage() < 2998){
            ...
            playerIn.addPotionEffect(new EffectInstance(Effects.STRENGTH, 100, 1, false, false));
        } else{
