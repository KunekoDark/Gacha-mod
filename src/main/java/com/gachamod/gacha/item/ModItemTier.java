...
public enum ModItemTier implements IItemTier {
    ...
    NORMAL(6,2000,9f,8f,10, () -> Ingredient.fromItems(ModItems.TERRESTRIAL_INGOT.get())),
    ...
    METEORTECH(7,10000,10f,15f,10, () -> Ingredient.fromItems(ModItems.METEOR_TECH_INGOT.get())),
    //add new tier here
    ;
